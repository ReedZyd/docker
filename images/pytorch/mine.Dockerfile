...
RUN wget -q https://repo.anaconda.com/miniconda/Miniconda3-4.3.0-Linux-x86_64.sh && \
    /bin/bash Miniconda3-4.3.0-Linux-x86_64.sh -b -p /opt/conda && \
    rm Miniconda3-4.3.0-Linux-x86_64.sh 
